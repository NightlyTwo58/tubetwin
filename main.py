...
MAX_VIDEOS = 5
MAX_COMMENTS = 10
BATCH_SIZE = 50  # videos per batch for videos().list

with open(CHANNEL_JSON, "r") as f:
    channel_ids = json.load(f).get("channels", [])
...
header = ['video_id', 'title', 'views', 'comment_author', 'comment_text', 'comment_likes']
